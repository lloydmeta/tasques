...
// 2020-07-04 22:32:20.378454 +0900 JST m=+0.079707631
    ...
    "definitions": {
        ...
        "recurring.NewTask": {
            ...
            "properties": {
                ...
                "skip_if_outstanding_tasks_exist": {
                    "description": "Whether or not to skip scheduling a Task for this if there are outstanding (not in DONE or DEAD status) Tasks\nthat belong to this Recurring Task.",
                    "type": "boolean",
                    "default": false
                },
                "task_definition": {
        ...
        "recurring.Task": {
            ...
            "properties": {
                ...
                "loaded_at": {
                    "description": "When this recurring Task was last acknowledged and _loaded_ by a Tasques server for later\nautomatic enqueueing",
                    "type": "string"
                },
                "metadata": {
        ...
        "task.NewTask": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "Optionally specified identifier of a Task (for idempotency). If not supplied, a UUID is generated and used",
                    "type": "string"
                },
                "kind": {
                    "description": "The kind of Task; corresponds roughly with a function name",
